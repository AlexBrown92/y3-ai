...
public class GeneticAlgorithm {
    ...
    public static final int NUMBER_OF_HIDDEN_NODES = 3;
    ...
    public static final double CROSSOVER_RATE = 0;
    public static final int GENE_SIZE = (NUMBER_OF_HIDDEN_NODES * NUMBER_OF_INPUTS) + NUMBER_OF_HIDDEN_NODES + (NUMBER_OF_HIDDEN_NODES + 1);
    ...
    public static void main(String[] args) throws FileNotFoundException, UnsupportedEncodingException, IOException {
        ...
        String dirPath = "C:\\Users\\Alex\\Dropbox\\Work\\Year 3\\AI\\Code\\Genetic_Algorithm3\\data\\";
        ...
        settings.println("NUMBER_OF_HIDDEN_NODES: " + NUMBER_OF_HIDDEN_NODES);
        settings.println("NUMBER_OF_INPUTS: " + NUMBER_OF_INPUTS);
        settings.println("NUMBER_OF_RUNS: " + NUMBER_OF_RUNS);
        settings.println("TOURNAMENT_SIZE: " + TOURNAMENT_SIZE);
        settings.println("MAX_MUTATION: " + MAX_MUTATION);
        ...
        fw.append("" + POPULATION_SIZE + "," + NUMBER_OF_HIDDEN_NODES + "," + NUMBER_OF_INPUTS + "," + NUMBER_OF_RUNS + "," + TOURNAMENT_SIZE + "," + MAX_MUTATION + "," + MUTATION_RATE + "," + CROSSOVER_RATE + "," + TEST_PERCENTAGE + "," + (fitnessSum / 10) + "," + (float) (epochTakenSum / 10) + "," + timeStamp + "\n");
        fw.close();
    } // main
